...
public class PluginManager implements Closeable {
    ...
    public PluginManager(Config cfg) {
        ...
        progressIndicator = this.cfg.getProgressIndicator();
    ...
    public void downloadPlugins(List<Plugin> plugins) {
        ...
        if (this.progressIndicator != null) {
            this.progressIndicator.setText("Installing dependencies");
        }
        ...
        try {
            ioThreadPool.submit(() -> plugins.parallelStream().forEach(plugin -> {
                ...
                if (successfulDownload && progressIndicator != null) {
                    int value = progress.incrementAndGet();
                    this.progressIndicator.setText2("Installing " + plugin.getName());
                    this.progressIndicator.setFraction((double) value / plugins.size());
                }
            })).get();
