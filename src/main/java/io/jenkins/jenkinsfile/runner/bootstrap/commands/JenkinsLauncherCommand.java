...
public abstract class JenkinsLauncherCommand implements Callable<Integer> {
    ...
    public File getJenkinsWar(final @CheckForNull String requiredVersion) throws IOException {
    ...
    public ClassLoader createJenkinsWarClassLoader() throws PrivilegedActionException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, IOException {
